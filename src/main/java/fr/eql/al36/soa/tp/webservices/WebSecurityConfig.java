...
import fr.eql.al36.soa.tp.webservices.util.JwtAuthenticationFilter;
import fr.eql.al36.soa.tp.webservices.util.MyNoAuthenticationEntryPoint;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(final HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.POST,"/rest/currency-api/public/login").permitAll()
		.antMatchers("/rest/currency-api/public/**").permitAll()
		.antMatchers(SWAGGER_AUTH_WHITELIST).permitAll()
		.antMatchers("/rest/currency-api/private/**").authenticated()
