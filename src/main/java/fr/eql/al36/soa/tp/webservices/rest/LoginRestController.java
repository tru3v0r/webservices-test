...
import fr.eql.al36.soa.tp.webservices.dto.LoginRequest;
import fr.eql.al36.soa.tp.webservices.dto.LoginResponse;
import fr.eql.al36.soa.tp.webservices.util.JwtTokenProvider;



@RestController
@RequestMapping(value="rest/currency-api/public/login" , headers="Accept=application/json")
public class LoginRestController {
	...
	//http://localhost:8484/webservices/rest/currency-api/public/login
